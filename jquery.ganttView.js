...
(function (jQuery) {
    ...
    var monthNames = ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"];
        ...
        function addVtHeader(div, data, cellHeight) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                for (var j = 0; j < data[i].series.length; j++) {
                  ...
                  if (data[i].series[j].series) {
                    for (var k = 0; k < data[i].series[j].series.length; k++) {
                      seriesDiv.append(jQuery("<div>", { "class": "ganttview-vtheader-series-name-1", "css": { "margin-left": 20 + "px" }})
                      .append(data[i].series[j].series[k].name));
                    }
                  }
                }
        ...
        function addHzHeader(div, dates, cellWidth) {
            ...
            var yearsDiv = jQuery("<div>", { "class": "ganttview-hzheader-years" });
            ...
            for (var y in dates) {
              ...
              yearsDiv.append(jQuery("<div>", {
                "class": "ganttview-hzheader-year",
                "css": { "width": totalW + "px" }
              }).append(y));
            }
            yearsDiv.css("width", totalW + "px");
            monthsDiv.css("width", totalW + "px");
            daysDiv.css("width", totalW + "px");
            headerDiv.append(yearsDiv).append(monthsDiv).append(daysDiv);
            div.append(headerDiv);
        }
        ...
        function applyLastClass(div) {
            ...
            jQuery("div.ganttview-hzheader-years div.ganttview-hzheader-year:last-child", div).addClass("last");
        }
